...
def train(directory):
    ...
    # geom_loss = SamplesLoss(loss="sinkhorn", p=2, blur=0.05)
    geom_loss = SamplesLoss(loss="sinkhorn", p=2, blur=0.05, backend="tensor")
    ...
    for epoch in range(num_epochs):
        ...
        loss = geom_loss(g_tensor_batch.view(-1, 3),  target_tensor.view(-1, 3))
